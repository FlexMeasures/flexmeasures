...
def permission_required_for_context(
    ...
    A custom response can be generated by passing an error_handler, which should be a function that accepts the context, permission and ctx_arg_name.
    ...
    def wrapper(fn):
        ...
        def decorated_view(*args, **kwargs):
            ...
            try:
                ...
                if error_handler:
                    return error_handler(context, permission, ctx_arg_name)
                raise e
