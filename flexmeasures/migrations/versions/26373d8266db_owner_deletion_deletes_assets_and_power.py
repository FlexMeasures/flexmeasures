...
def upgrade():
    ...
    op.drop_constraint("asset_owner_id_fkey", "asset", type_="foreignkey")
    op.create_foreign_key(
        None, "asset", "bvp_users", ["owner_id"], ["id"], ondelete="CASCADE"
    )
    op.drop_constraint("power_asset_id_fkey", "power", type_="foreignkey")
    op.create_foreign_key(
...
def downgrade():
    ...
    op.create_foreign_key("power_asset_id_fkey", "power", "asset", ["asset_id"], ["id"])
    op.drop_constraint(None, "asset", type_="foreignkey")
    op.create_foreign_key(
        "asset_owner_id_fkey", "asset", "bvp_users", ["owner_id"], ["id"]
    )
    # ### end Alembic commands ###
