...
def upgrade():
    ...
    #
    # op.add_column('power', sa.Column('sensor_id', sa.Integer(), nullable=False))
    # op.drop_index('power_asset_id_idx', table_name='power')
    # op.create_index(op.f('power_sensor_id_idx'), 'power', ['sensor_id'], unique=False)
    # op.drop_constraint('power_asset_id_asset_fkey', 'power', type_='foreignkey')
    # op.create_foreign_key(op.f('power_sensor_id_sensor_fkey'), 'power', 'sensor', ['sensor_id'], ['id'], ondelete='CASCADE')
    # op.drop_column('power', 'asset_id')
    #
    # op.add_column('price', sa.Column('sensor_id', sa.Integer(), nullable=False))
    # op.drop_index('price_market_id_idx', table_name='price')
    # op.create_index(op.f('price_sensor_id_idx'), 'price', ['sensor_id'], unique=False)
    # op.drop_constraint('price_market_id_market_fkey', 'price', type_='foreignkey')
    # op.create_foreign_key(op.f('price_sensor_id_sensor_fkey'), 'price', 'sensor', ['sensor_id'], ['id'])
    # op.drop_column('price', 'market_id')
    #
    # op.drop_constraint('weather_sensor_id_weather_sensor_fkey', 'weather', type_='foreignkey')
    # op.create_foreign_key(op.f('weather_sensor_id_sensor_fkey'), 'weather', 'sensor', ['sensor_id'], ['id'])
    #
...
def downgrade():
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    #
    # op.drop_constraint(op.f('weather_sensor_id_sensor_fkey'), 'weather', type_='foreignkey')
    # op.create_foreign_key('weather_sensor_id_weather_sensor_fkey', 'weather', 'weather_sensor', ['sensor_id'], ['id'])
    #
    # op.add_column('price', sa.Column('market_id', sa.INTEGER(), autoincrement=False, nullable=False))
    # op.drop_constraint(op.f('price_sensor_id_sensor_fkey'), 'price', type_='foreignkey')
    # op.create_foreign_key('price_market_id_market_fkey', 'price', 'market', ['market_id'], ['id'])
    # op.drop_index(op.f('price_sensor_id_idx'), table_name='price')
    # op.create_index('price_market_id_idx', 'price', ['market_id'], unique=False)
    # op.drop_column('price', 'sensor_id')
    #
    # op.add_column('power', sa.Column('asset_id', sa.INTEGER(), autoincrement=False, nullable=False))
    # op.drop_constraint(op.f('power_sensor_id_sensor_fkey'), 'power', type_='foreignkey')
    # op.create_foreign_key('power_asset_id_asset_fkey', 'power', 'asset', ['asset_id'], ['id'], ondelete='CASCADE')
    # op.drop_index(op.f('power_sensor_id_idx'), table_name='power')
    # op.create_index('power_asset_id_idx', 'power', ['asset_id'], unique=False)
    # op.drop_column('power', 'sensor_id')
    #
    # ### end Alembic commands ###
