...
def update_automation(
    ...
    Anything that changes which occurrences are due, namely the recurrence, the timezone and reactivation,
    also rebases the scheduling cursor, so that occurrences from before the change are not caught up on.
    An audit log record is added to the asset.
