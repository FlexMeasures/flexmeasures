...
def device_scheduler(  # noqa C901
    ...
    model.device_energy_upper_bound = Constraint(model.d, model.j, rule=device_upper_bounds)
    model.device_energy_lower_bound = Constraint(model.d, model.j, rule=device_lower_bounds)
