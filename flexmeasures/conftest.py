...
def create_roles_users(db, test_accounts) -> dict[str, User]:
    ...
    new_users.append(
        create_user(
            ...
            email="test_consultant_user_without_access@seita.nl",
            account_name=test_accounts["Consultant"].name,
            password="testtest",
        )
    )
    new_users.append(
        create_user(
            username="Test ConsultantClient User",
            email="test_consultant_client_user@seita.nl",
            account_name=test_accounts["ConsultantClient"].name,
            password="testtest",
        )
    )
