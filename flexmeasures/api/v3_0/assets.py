    ...
    def trigger_report(self, id: int, asset: GenericAsset):
        ...
        post:
          ...
          description: |
            ...
            `create-children` access to the asset. The caller must be able to read every
            input sensor and record data on every output sensor. Output sensors must
            belong to the given asset or one of its descendants.
              ...
              content:
                application/json:
                  ...
                  examples:
                    successful_response:
                      description: |
                        This message indicates that the reporting request has been accepted for processing.
