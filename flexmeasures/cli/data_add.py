...
def _check_report_template_use(
    template_name: str | None, automation_type: str, source: DataSource | None
) -> None:
    """Abort if --template is given to an automation that a report template cannot apply to."""
...
def add_automation(
    ...
    **kwargs,
    ...
    _check_report_template_use(template_name, automation_type, source)
    ...
    if template_name is not None:
        generator_class, config, parameters = _apply_report_template(
            template_name, generator_class, config, parameters
        )
