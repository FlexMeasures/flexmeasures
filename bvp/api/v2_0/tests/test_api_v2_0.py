...
from bvp.api.tests.utils import get_auth_token, UserContext
from bvp.api.v2_0.tests.utils import get_asset_post_data
...
def test_get_assets_badauth(client, use_auth):
    ...
    get_assets_response = client.get(
        url_for("bvp_api_v2_0.get_assets"), query_string=query, headers=headers
    )
...
def test_get_asset_nonadmin_access(client):
    ...
    asset_response = client.get(
        url_for("bvp_api_v2_0.get_asset", id=supplier_assets[0].id),
        headers=headers,
    ...
    asset_response = client.get(
        url_for("bvp_api_v2_0.get_asset", id=prosumer_assets[0].id),
        headers=headers,
        follow_redirects=True,
    )
    ...
    asset_response = client.get(
        url_for("bvp_api_v2_0.get_asset", id=8171766575),
        headers=headers,
        follow_redirects=True,
    )
...
def test_get_assets(client, use_owner_id, num_assets):
    ...
    get_assets_response = client.get(
        url_for("bvp_api_v2_0.get_assets"),
        query_string=query,
...
def test_alter_an_asset_wrongauth(client):
    ...
    asset_edit_response = client.patch(
        url_for("bvp_api_v2_0.patch_asset", id=prosumer_asset.id),
        headers={"content-type": "application/json", "Authorization": auth_token},
        json={},
    )
    ...
    asset_delete_response = client.delete(
        url_for("bvp_api_v2_0.delete_asset", id=prosumer_asset.id),
        headers={"content-type": "application/json", "Authorization": auth_token},
        json={},
    )
    ...
    asset_delete_response = client.delete(
        url_for("bvp_api_v2_0.delete_asset", id=supplier_asset.id),
        headers={"content-type": "application/json", "Authorization": auth_token},
        json={},
    )
    assert asset_delete_response.status_code == 403
...
def test_edit_an_asset(client, db):
    ...
    edit_asset_response = client.patch(
        url_for("bvp_api_v2_0.patch_asset", id=existing_asset.id),
        json=post_data,
        headers={"content-type": "application/json", "Authorization": auth_token},
    )
...
def test_delete_an_asset(client, db):
    ...
    edit_asset_response = client.delete(
        url_for("bvp_api_v2_0.delete_asset", id=existing_asset_id),
        headers={"content-type": "application/json", "Authorization": auth_token},
    )
