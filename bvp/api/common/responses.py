...
def invalid_sender(user_role_names: Union[str, List[str]], *allowed_role_names: str) -> Tuple[dict, int]:
...
def ptus_incomplete() -> Tuple[dict, int]:
    return dict(result="Rejected", status="PTUS_INCOMPLETE", message="Missing values."), 400
