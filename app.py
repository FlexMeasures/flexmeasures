...
from utils.config_utils import read_config, configure_logging
from utils.time_utils import localized_datetime, naturalized_datetime
...
from models.user import User, Role, remember_login
...
# Register views
from views import bvp_views, bvp_error_views
app.register_blueprint(bvp_views)
app.register_blueprint(bvp_error_views)

from crud.assets import AssetCrud
...
def populate_db_structure():
    ...
    from scripts import db_handling
