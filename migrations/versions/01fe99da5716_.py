...
def upgrade():
    ...
    op.create_index(op.f('ix_asset_type_can_curtail'), 'asset_type', ['can_curtail'], unique=False)
    op.create_index(op.f('ix_asset_type_can_shift'), 'asset_type', ['can_shift'], unique=False)
