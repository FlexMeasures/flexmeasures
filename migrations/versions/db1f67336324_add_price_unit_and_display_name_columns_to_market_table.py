...
def upgrade():
    op.add_column('market', sa.Column('display_name', sa.String(length=80), nullable=False, server_default=""))
    op.execute(
        """
    ...
    op.add_column('market', sa.Column('price_unit', sa.String(length=80), nullable=False, server_default=""))
    op.execute(
        """
