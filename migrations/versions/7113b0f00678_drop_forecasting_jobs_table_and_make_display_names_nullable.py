...
def upgrade():
    ...
    op.alter_column('asset_type', 'display_name',
               existing_type=sa.VARCHAR(length=80),
               nullable=True,
               existing_server_default=sa.text("''::character varying"))
    op.alter_column('market', 'display_name',
               existing_type=sa.VARCHAR(length=80),
               nullable=True,
               existing_server_default=sa.text("''::character varying"))
    op.alter_column('market_type', 'display_name',
               existing_type=sa.VARCHAR(length=80),
               nullable=True,
               existing_server_default=sa.text("''::character varying"))
    op.alter_column('weather_sensor_type', 'display_name',
               existing_type=sa.VARCHAR(length=80),
               nullable=True,
               existing_server_default=sa.text("''::character varying"))
...
def downgrade():
    ...
    op.alter_column('asset_type', 'display_name',
               ...
               nullable=False,
               existing_server_default=sa.text("''::character varying"))
    op.create_table('forecasting_job',
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('timed_value_type', sa.VARCHAR(length=30), autoincrement=False, nullable=False),
    ...
    sa.Column('horizon', postgresql.INTERVAL(), autoincrement=False, nullable=False),
    sa.Column('in_progress_since', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=True),
