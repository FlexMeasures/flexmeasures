...
* Keep around finished forecasting jobs as long as the ``FLEXMEASURES_PLANNING_TTL`` config setting [see `PR #1890 <https://github.com/FlexMeasures/flexmeasures/pull/1890>`_]
