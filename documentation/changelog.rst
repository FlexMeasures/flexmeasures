...
* Added API endpoints `/sensors/<id>` for fetching a single sensor, `/sensors` (POST) for adding a sensor, `/sensors/<id>` (PATCH) for updating a sensor and `/sensors/<id>` (DELETE) for deleting a sensor. [see `PR #759 <https://www.github.com/FlexMeasures/flexmeasures/pull/759>`_,  `PR #767 <https://www.github.com/FlexMeasures/flexmeasures/pull/767>`_, `PR #773 <https://www.github.com/FlexMeasures/flexmeasures/pull/773>`_, `PR #784 <https://www.github.com/FlexMeasures/flexmeasures/pull/784>`_ and `PR #802 <https://www.github.com/FlexMeasures/flexmeasures/pull/802>`_]
