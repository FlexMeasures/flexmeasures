...
* New API endpoints to create annotations for accounts, assets, and sensors: `[POST] /api/dev/annotation/accounts/(id)`, `[POST] /api/dev/annotation/assets/(id)`, and `[POST] /api/dev/annotation/sensors/(id)` [see `PR #1968 <https://github.com/FlexMeasures/flexmeasures/pull/1968>`_]
