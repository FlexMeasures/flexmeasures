...
Bugfixes
-----------
* A forecaster given more than one regressor of the same kind trained on each of them several times over, because every regressor's data was collected once per regressor [see `PR #2555 <https://www.github.com/FlexMeasures/flexmeasures/pull/2555>`_]
