...
* Add ``flexmeasures jobs inspect-job`` CLI command to show the same job status and metadata information that is available from the unified job status endpoint [see `PR #XXXX <https://www.github.com/FlexMeasures/flexmeasures/pull/XXXX>`_].
