...
* Added Logo URL to account for white-labelled UI themes [see `PR #1137 <https://github.com/FlexMeasures/flexmeasures/pull/1137>`_]
...
* Add new annotation types: ``"error"`` and ``"warning"`` [see `PR #1145 <https://github.com/FlexMeasures/flexmeasures/pull/1145>`_]
