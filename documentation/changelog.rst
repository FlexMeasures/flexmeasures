...
* The flex-context editor now also shows the fields that scheduling the asset would inherit from ancestor assets — uneditable, with buttons to jump to the editor of the defining ancestor or to override the field on the asset itself [see `PR #2346 <https://www.github.com/FlexMeasures/flexmeasures/pull/2346>`_]
