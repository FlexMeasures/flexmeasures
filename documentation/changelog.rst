...
Bugfixes
-----------
* Creating an organisation now records the action in its audit log, whether it is created in the UI, through the API or from the CLI [see `PR #XXXX <https://www.github.com/FlexMeasures/flexmeasures/pull/XXXX>`_]
