...
* Add a "Create forecast" button to the sensor page, which triggers a 24-hour regression forecast via one click. Visible to users with ``create-children`` permission on the sensor and enabled when at least two days of data are present [see `PR #1985 <https://www.github.com/FlexMeasures/flexmeasures/pull/1985>`_]
