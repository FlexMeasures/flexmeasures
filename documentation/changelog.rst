...
* Modified Account model :abbr:`ACL (access control list)` to give consultant role more permissions as well as testcases to check if these permissions work as expected [see `PR #1539 <https://github.com/FlexMeasures/flexmeasures/pull/1539>`_]
