...
* Building a custom application in a test or with ``do_configure_logging=False`` no longer reconfigures root logger handlers and strips pytest's ``caplog`` handler [see `PR #2484 <https://github.com/FlexMeasures/flexmeasures/pull/2484>`_]
