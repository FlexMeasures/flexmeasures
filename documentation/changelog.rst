...
Bugfixes
-----------
* Annotation labels on sensor and asset charts no longer flicker while moving between beliefs in the same annotated range [see `PR #XXXX <https://www.github.com/FlexMeasures/flexmeasures/pull/XXXX>`_]
