...
* Add optional per-graph ``description`` field to ``sensors_to_show`` to show a small-font line below each subplot title in the ECharts renderer (Vega-Lite unchanged) [see `issue #1194 <https://github.com/FlexMeasures/flexmeasures/issues/1194>`_]
