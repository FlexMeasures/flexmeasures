...
* Added :abbr:`2FA (two-factor authentication)` support for email, one time recovery and added ``_macros.html`` for UI components [see `PR #1555 <https://github.com/FlexMeasures/flexmeasures/pull/1555>`_ and `PR #1562 <https://github.com/FlexMeasures/flexmeasures/pull/1562>`_]
