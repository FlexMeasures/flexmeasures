...
* Hover over an organisation's plan on its page to see its effective API rate limits and trigger rate-limit scope [see `PR #XXXX <https://www.github.com/FlexMeasures/flexmeasures/pull/XXXX>`_]
