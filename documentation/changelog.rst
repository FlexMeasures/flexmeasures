...
- A Consultancy account can be added to any account, with the effect that the users in that account get read access. [see `PR #846 <https://github.com/FlexMeasures/flexmeasures/pull/877>`_]
