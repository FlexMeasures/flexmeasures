...
* Added API endpoints and webpages `/accounts` and `/account/<id>` to list accounts and show a single account [see `PR #605 <https://github.com/FlexMeasures/flexmeasures/pull/605>`_]
