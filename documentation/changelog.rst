...
* Forecasting regressors can filter their input beliefs by data source, source type, excluded source type, or source organisation [see `issue #2337 <https://github.com/FlexMeasures/flexmeasures/issues/2337>`_]
