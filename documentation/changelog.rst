...
* Speed up ``device_scheduler`` model construction by precomputing numpy constraint arrays for Pyomo parameter initialization [see `PR #2291 <https://www.github.com/FlexMeasures/flexmeasures/pull/2291>`_]
