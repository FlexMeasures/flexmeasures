...
* Add ``--timezone`` option to ``flexmeasures add holidays`` to store holiday annotations at local midnight instead of UTC midnight [see `PR #2176 <https://www.github.com/FlexMeasures/flexmeasures/pull/2176>`_]
* Add new ``flexmeasures add holidays-by-package`` command backed by the ``holidays`` Python package, supporting more countries and school holidays [see `PR #2176 <https://www.github.com/FlexMeasures/flexmeasures/pull/2176>`_]
* Add ``future-annotation-regressors`` field to the forecasting pipeline config schema, allowing annotation sources (e.g. holidays) to be used as binary future regressors [see `PR #2176 <https://www.github.com/FlexMeasures/flexmeasures/pull/2176>`_]
