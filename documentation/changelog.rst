...
* Speed up scheduling on longer horizons by expressing device stock as a recursive balance instead of a running sum, so the number of model nonzeros grows linearly rather than quadratically with the horizon (about 10x faster solves at the 2-day default horizon, 23x at 3 days) [see `PR #2282 <https://www.github.com/FlexMeasures/flexmeasures/pull/2282>`_]
