...
* Improved view of site structure in the UI, by showing a cross-section of the asset tree, rather than a cross section of the branch only [see `PR #1553 <https://github.com/FlexMeasures/flexmeasures/pull/1553>`_]
