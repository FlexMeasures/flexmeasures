...
* Documentation: new Concepts sections for time-series beliefs and flexibility configuration, and expanded the scheduling overview with practical API examples and diagrams. [see `PR #2420 <https://www.github.com/FlexMeasures/flexmeasures/pull/2420>`_]
