...
* A commitment in the flex-context now requires a ``baseline`` and at least one deviation price (``up-price`` and/or ``down-price``), as already documented [see `PR #2287 <https://www.github.com/FlexMeasures/flexmeasures/pull/2287>`_]
