...
Bugfixes
-----------
* Ticking *Set as default view* on an asset's Automations page had no effect, so the assets you clicked next kept opening on Context; that view can now be made your default, and a view preference the server refuses is reported instead of quietly dropped [see `PR #XXXX <https://www.github.com/FlexMeasures/flexmeasures/pull/XXXX>`_]
