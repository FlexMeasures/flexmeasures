...
* In the UI, the flex-context editor supports editing commitments (name, commodity, baseline and deviation prices, each accepting a fixed value or a sensor), also within each commodity context [see `PR #2286 <https://www.github.com/FlexMeasures/flexmeasures/pull/2286>`_]
* Commitments in the flex-context support a ``commodity`` field, defaulting to electricity, to bind a commitment to that commodity's devices [see `PR #2286 <https://www.github.com/FlexMeasures/flexmeasures/pull/2286>`_]
