...
----------------------
* Look up which data sources recorded for which sensors from a small summary table instead of scanning the beliefs table [see `PR #PRNUM <https://www.github.com/FlexMeasures/flexmeasures/pull/PRNUM>`_]
