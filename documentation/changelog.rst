...
* Added ``root`` and ``depth`` fields to the `[GET] /assets` endpoint for listing assets, to allow selecting descendants of a given root asset up to a given depth [see `PR #1874 <https://www.github.com/FlexMeasures/flexmeasures/pull/1874>`_ and `PR #1899 <https://www.github.com/FlexMeasures/flexmeasures/pull/1899>`_]
