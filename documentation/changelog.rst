...
* Speed up app boot by ~1s by dropping the ``inflect`` dependency in favor of the already-used, much lighter ``inflection`` package [see `PR #2514 <https://www.github.com/FlexMeasures/flexmeasures/pull/2514>`_]
