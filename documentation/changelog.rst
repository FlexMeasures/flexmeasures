...
* Stamp a ``LatestTaskRun`` with the time it is recorded, rather than with the time the FlexMeasures process started [see `PR #2303 <https://www.github.com/FlexMeasures/flexmeasures/pull/2303>`_]
