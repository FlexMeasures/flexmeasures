...
* Asking the API for a window of a day or longer now follows the calendar, as ISO 8601 says it should: a ``P1D`` window of a sensor in Europe/Amsterdam covers 23 hours on the day daylight saving time starts and 25 on the day it ends, where it used to always cover 24, while ``PT24H`` keeps meaning exactly 24 hours [see `PR #XXXX <https://www.github.com/FlexMeasures/flexmeasures/pull/XXXX>`_]
