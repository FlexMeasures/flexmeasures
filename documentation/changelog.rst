...
* Show automation job counts in one batched asset request, load full automation details on demand, and support editing an automation's name, recurrence, timezone and activation state in the UI [see `PR #2299 <https://www.github.com/FlexMeasures/flexmeasures/pull/2299>`_]
