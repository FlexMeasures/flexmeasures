...
* Automations can also compute schedules on a recurring basis (``flexmeasures add automation --type scheduling``), with the schedule start defaulting to each run's time [see `PR #2293 <https://www.github.com/FlexMeasures/flexmeasures/pull/2293>`_]
