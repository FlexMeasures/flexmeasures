...
* Add support for intermediate power constraints on groups of devices, via a new ``group`` field in the storage flex-model [see `issue #2092 <https://github.com/FlexMeasures/flexmeasures/issues/2092>`_]
