...
* New API endpoints to create annotations for accounts, assets, and sensors: `[POST] /annotation/accounts/(id) <api/v3_0.html#post--api-v3_0-annotation-accounts-id>`_, `[POST] /annotation/assets/(id) <api/v3_0.html#post--api-v3_0-annotation-assets-id>`_ and `[POST] /annotation/sensors/(id) <api/v3_0.html#post--api-v3_0-annotation-sensors-id>`_ [see `PR #1968 <https://github.com/FlexMeasures/flexmeasures/pull/1968>`_]
