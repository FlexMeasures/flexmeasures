...
Bugfixes
-----------
* Annotation labels on sensor and asset charts no longer flicker while moving between beliefs, can be pinned by clicking their range, and use separate rows when pinned and hovered labels are visible together [see `PR #XXXX <https://www.github.com/FlexMeasures/flexmeasures/pull/XXXX>`_]
