...
- A Consultancy account can be added that has read access to accounts its id in the `consultancy_account_id` column. [see `PR #846 <https://github.com/FlexMeasures/flexmeasures/pull/877>`_]
