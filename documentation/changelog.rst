...
* Schedules saved to the flex-context's ``aggregate-consumption`` sensor had their sign flipped, showing production where consumption was scheduled and vice versa, because the sign convention implied by the field name was never recorded on the sensor [see `PR #XXXX <https://www.github.com/FlexMeasures/flexmeasures/pull/XXXX>`_]
