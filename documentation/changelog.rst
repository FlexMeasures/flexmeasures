...
New features
-------------
* Support filtering asset and sensor lists by ID prefix through API-backed search fields [see `PR #XXXX <https://www.github.com/FlexMeasures/flexmeasures/pull/XXXX>`_]
