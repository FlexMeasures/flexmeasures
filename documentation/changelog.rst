...
Bugfixes
-----------
* A schedule computed by an automation is now refused if it would record data on a sensor that was not among the ones checked against the automation creator's permissions, instead of recording it on a sensor that was only ever checked for read access [see `PR #2536 <https://www.github.com/FlexMeasures/flexmeasures/pull/2536>`_]
