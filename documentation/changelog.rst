...
----------------------
* Declare ``limits`` as a direct dependency, as we import it ourselves to validate rate limits, rather than relying on it arriving as a dependency of ``Flask-Limiter`` [see `PR #2404 <https://www.github.com/FlexMeasures/flexmeasures/pull/2404>`_]
