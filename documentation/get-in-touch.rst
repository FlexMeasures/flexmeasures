...
- Join the ``#flexmeasures`` Slack channel over at `https://slack.lfenergy.org <https://slack.lfenergy.org>`_
- Come by one of the Technical Steering Committee meetings, held via Zoom every six weeks. They're open for beginners (learn what it is) as well as existing users (what goes on the roadmap?). The agenda is `here <https://zoom-lfx.platform.linuxfoundation.org/meetings/flexmeasures>`_.
