...
.. The qrefs make links very similar to the openapi plugin, but we have to run a sed command after the fact to make them exactly alike (see the update-docs poe task)
.. qrefflask:: flexmeasures.app:create(env="documentation")
    :modules: flexmeasures.api, flexmeasures.api.v3_0.assets, flexmeasures.api.v3_0.sensors, flexmeasures.api.v3_0.jobs, flexmeasures.api.v3_0.accounts, flexmeasures.api.v3_0.users, flexmeasures.api.v3_0.health, flexmeasures.api.v3_0.public
    :order: path
